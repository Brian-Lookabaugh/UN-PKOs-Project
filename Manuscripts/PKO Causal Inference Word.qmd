...
That is not to say, however, that causal research is *impossible* in the peacekeeping literature. In select instances, researchers have manage to execute randomized controlled trials (RCTs) where access to the treatment is randomized so that no confounding can occur and causal estimates be be made (). However, these approaches are few and far between. Practically speaking, researchers do not typically have a say concerning the targets of peacebuilding programs, especially when that peacebuilding program is a PKO. Further, even if researchers had such capacity, it would be unethical to randomly assign potentially life-saving peacebuilding programs to some countries while others did not receive such treatment.
...
# Difference-in-Differences and Segue

A final, although less utilized, method for making causal inferences from peacekeeping is difference-in-differences. To my knowledge, only one contribution to the literature has been made using this approach (Phayal 2019). 
